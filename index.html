...
<html lang="en">
  <head>
    <title>MR.HR Solutions &mdash; By DevTeam-09</title>
    <meta charset="utf-8">
    ...
    <header class="site-navbar mt-3" id="top">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="site-logo col-6"><a href="index.html">MR.HR Solutions</a></div>
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-lg-block">
              ...
              <li><a href="contact.html">Contact</a></li>
                <li><a href="./web/signIn.jsp">Sign In</a></li>
            </ul>
          </nav>
        ...
        <div class="row">
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="service-single.html" class="block__16443 text-center d-block">
              ...
              <p>Market research is the process of determining the viability of a new service or product through research conducted directly with potential customers. Market research allows a company to discover the target market and get opinions and other feedback from consumers about their interest in the product or service.</p>
            </a>            
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="service-single.html" class="block__16443 text-center d-block">
              ...
              <p>A business plan is an essential written document that provides a description and overview of your company's future. All businesses should have a business plan. The plan should explain your business strategy and your key goals to get from where you are now to where you want to be in the future.</p>
            </a>            
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="service-single.html" class="block__16443 text-center d-block">
              ...
              <h3>Content Article writing</h3>
              <p>Content writing is the process of planning, writing and editing web content, typically for digital marketing purposes. It can include writing blog posts and articles, scripts for videos and podcasts, as well as content for specific platforms, such as tweetstorms on Twitter or text posts on Reddit.</p>
            </a>
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="service-single.html" class="block__16443 text-center d-block">
              ...
              <p>Social media marketing (SMM) is a form of internet marketing that uses social media apps as a marketing tool. These social media platforms enable brands to connect with their audience to: build a brand, increase sales, drive traffic to a website</p>
            </a>
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="service-single.html" class="block__16443 text-center d-block">
              ...
              <h3>360 Business</h3>
              <p class="d-sm-block">A 360-degree view of a customer is a collection of all your customer data in one place. From the basic contact information on customers, to all their past and present purchasing data and all interactions with customer service, as well as their social media behavior.</p>
            </a>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-6 col-md-3 mb-4 mb-md-0">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="#">Content Article writing</a></li>
              <li><a href="#">Social Media Marketing</a></li>
              <li><a href="#">360 Business</a></li>
            </ul>
          </div>
          <div class="col-6 col-md-3 mb-4 mb-md-0">
            <h3>Company</h3>
        ...
        <div class="row text-center">
          <div class="col-12">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | JSSGD </a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </small></p>
          </div>
        </div>
